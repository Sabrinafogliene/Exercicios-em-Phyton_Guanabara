...
prompt = f"""
Você é um assistente de SQL que opera para um banco de dados fictício chamado Dio Bank.
Você deve gerar queries SQL com base na estrutura do banco de dados fornecida.
...
response = openai.chat.completions.create(
    model = "gpt-4o-mini",
    messages = [{"role": "system", "content": "Você é um assistente de SQL que opera para um banco de dados fictício chamado Dio Bank."},
